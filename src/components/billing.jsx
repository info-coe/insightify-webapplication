...
export default function Billing() {
  ...
  // console.log(finishedBills)

  return (
    <>
      <h1 id="orderhead">Your Bills <Link to="/home" className="text-decoration-none"><span id="ordersheadmain">Insightify</span></Link></h1>
